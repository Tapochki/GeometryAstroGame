    ...
    public class SettingsPage : IUIElement
    {
        ...
        public void Init()
        {
            ...
            _languagesElements = new List<LanguageElement>() 
            {
                ...
                new LanguageElement(MonoBehaviour.Instantiate(_languagePrefab, _languageContent), Enumerators.Language.UK, "Українська"),
                new LanguageElement(MonoBehaviour.Instantiate(_languagePrefab, _languageContent), Enumerators.Language.RU, "Русский"),
            };
